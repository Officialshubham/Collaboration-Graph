...
df2 = pd.read_excel("backend\Data\Investigators Data\Investigators Internal.xlsx")
...
td = date.today()
df2.to_excel(f'backend\Data\Investgator Final Data\Project File Internal {td}.xlsx')
